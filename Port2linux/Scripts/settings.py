...
# ----------------------------------------------------------------------
# --- CONSTANTS, PATHS, AND GLOBALS (LINUX VERSION) ---
# ----------------------------------------------------------------------
...
#  os.path.expanduser("~") για να λειτουργεί σε οποιονδήποτε χρήστη Linux
HOME_DIR = os.path.expanduser("~")

# --- Define fixed absolute paths and folder names ---
ENGLISH_BASE_PATH = os.path.join(HOME_DIR, "DedSec/Scripts")
...
LANGUAGE_JSON_PATH = os.path.join(HOME_DIR, ".dedsec_language.json")
BACKUP_ZIP_PATH = os.path.join(HOME_DIR, "Linux_Backup.zip")
